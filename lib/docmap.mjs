 ...
 */
export function parseCapabilities(repo, capabilityConfig, tracked = trackedFiles(repo)) {
...
const rulingRows = (idx, id) => {
  const e = idx.get(id)
  return e && e.rows.length ? e.rows : null
}
const coverageFor = (idx, id) => (idx.get(id) || {}).cover || null
