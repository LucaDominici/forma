...
// Codepoint order, never String.prototype's locale-aware compare: ICU collation is
// locale-dependent (F2 — `sv_SE` sorts diacritics after `z`, `en_US`/`C` do not), so a room
// composed on one machine could fail `check` on another, or reorder silently. Shared here because
// both roomderive.mjs and verify.mjs already import audit.mjs.
