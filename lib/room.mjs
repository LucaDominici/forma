...
import { resolveProgramPaths, activePrograms, excludedPrograms, snapshotManifestErrors, arbiterMilestonesPath, loadArbiterMilestones } from './roomload.mjs'
...
const loadedPrograms = active.map((program) => {
  ...
  const derived = deriveAll({ repo, model, topo, issuesSnapshot, health, findings, brief, briefPath: paths.brief, manifest: paths.programManifest, gateInputs, arbiterMilestones, docs, hasMapDeclared: hasMap }, deriveContext)
