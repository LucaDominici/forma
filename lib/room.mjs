...
const loadedPrograms = active.map((program) => {
  ...
  const deriveContext = {}
  const derived = deriveAll({ repo, model, topo, issuesSnapshot, health, findings, brief, briefPath: paths.brief, manifest: paths.programManifest, gateInputs }, deriveContext)
