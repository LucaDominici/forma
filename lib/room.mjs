...
import { resolveProgramPaths, activePrograms, excludedPrograms, duplicateProgramIds } from './roomload.mjs'
...
const ROOM = {
  meta: {
    title: manifest.title || (loadedPrograms.length === 1 ? loadedPrograms[0].id : 'Control Room'),
