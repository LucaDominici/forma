...
const loadedPrograms = active.map((program) => {
  ...
  const derived = deriveAll({ repo, model, topo, issuesSnapshot, health, findings, brief, briefPath: paths.brief, manifest: paths.programManifest, gateInputs, arbiterMilestones, docs }, deriveContext)
