...
export function deriveAll({ repo, model, topo, issuesSnapshot, health, healthVerdicts, findings, brief, briefPath, manifest, gateInputs, arbiterMilestones, arbiterUseCases, arbiterRunbooks, docs, hasMapDeclared }, context) {
