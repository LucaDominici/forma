...
import { classifyDependencyConfirmationStaleness, classifyFindingStaleness, classifyVerdictStaleness, hashEvidence } from './audit.mjs'
...
export function deriveAll({ repo, model, topo, issuesSnapshot, health, healthVerdicts, findings, manifest, gateInputs }, context) {
