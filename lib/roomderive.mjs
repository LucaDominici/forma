...
import { classifyClaimStaleness, classifyDependencyConfirmationStaleness, classifyFindingStaleness, classifyVerdictStaleness, classifyVerification, codepointCompare, hashEvidence } from './audit.mjs'
