...
import { classifyDependencyConfirmationStaleness, classifyVerdictStaleness, hashEvidence } from './audit.mjs'
...
export function deriveAll({ repo, model, topo, issuesSnapshot, health, healthVerdicts, manifest, gateInputs }, context) {
