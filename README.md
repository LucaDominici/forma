...
**[▶ The explorer](https://LucaDominici.github.io/forma/)** · **[▶ The Control Room](https://LucaDominici.github.io/forma/room/)**

Two demos, two subjects. The briefing is forma reading **itself**: its own plan, its requirements
matrix, its documents, composed in CI from this repository's public issues. The explorer is
deliberately **not** this repo. It is `haben`, a
